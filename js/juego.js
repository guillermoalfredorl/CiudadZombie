...
var Juego = {
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 460, 250, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 460, 250, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 780, 250, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 740, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 170, 470, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 310, 160, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 350, 470, 30, 15, 1),
    new Obstaculo('imagenes/auto_rojo_arriba.png', 550, 450, 15, 30, 1),
...
Juego.dibujar = function () {
    ...
    Dibujante.dibujarRectangulo('yellow', 760, 480, 125, 8);
...
Juego.chequearColisiones = function (x, y) {
    ...
    this.obstaculos().forEach(function (obstaculo) {
        if (this.intersecan(obstaculo, this.jugador, x, y)) {
            ...
            obstaculo.quitarVida(this.jugador);
            puedeMoverse = false
        }
    }, this)
    return puedeMoverse
